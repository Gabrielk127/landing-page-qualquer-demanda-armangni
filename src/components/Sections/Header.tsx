...
const Header: React.FC = () => {
  ...
  "
              >
                Entregamos a melhor{" "}
                <span className="text-custom-text-title">estratégia</span> e
                consultoria para expansão do seu{" "}
                <span className="text-custom-text-title">negocio</span>
              </h1>
              <p
            ...
            "
              >
                Na hora de investir ou expandir o seu negócio existe a melhor
                forma para fazê-lo com equilíbrio entre seu capital próprio e o
                capital financiado, deixe-nos entender sua demanda que lhe
                apresentaremos a melhor opção.
              </p>
            </div>
